...
func (cr configRepository) Save(cfg certs.Cert) (string, error) {
	q := `INSERT INTO certs (thing_id, , name, client_cert, client_key, ca_cert, mainflux_key, external_id, external_key, content, state)
