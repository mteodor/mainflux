...
type UserRepository interface {
	...
	// RetrieveAll retrieves all users for given array of ids.
	RetrieveAll(ctx context.Context, offset, limit uint64, ids []string, email string, m Metadata) (UserPage, error)
