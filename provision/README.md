...
| MF_PROVISION_THINGS_LOCATION        | Things service URL                                | http://things:8180               |
| MF_PROVISION_LOG_LEVEL              | Service log level                                 | http://localhost                 |
| MF_PROVISION_HTTP_PORT              | Service listening port                            | 8091                             |
| MF_PROVISION_BS_SVC_URL             | Mainflux Bootstrap service URL                    | http://localhost:8202/things     |
| MF_PROVISION_BS_SVC_WHITELIST_URL   | Mainflux Bootstrap service whitelist URL          | http://localhost:8202/things     |
